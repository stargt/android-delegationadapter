...
import im.toss.delegationadapter.kotlin.ListItemDelegationAdapter
...
class MainKotlinActivity : AppCompatActivity() {
  ...
  class AnimalAdapter : ListItemDelegationAdapter<DisplayableItem>() {
    ...
    init {
      ...
      addDelegate(newDelegateBuilder<Gecko>()
      ...
      addDelegate(newDelegateBuilder<Snake>()
