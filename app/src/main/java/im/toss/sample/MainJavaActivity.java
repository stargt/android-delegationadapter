    ...
    AnimalAdapter() {
      ...
      addDelegate(createDelegateBuilder(Cat.class)
          ...
          .binder(new ViewBinder<Cat>() {
            @Override
            public void onBindViewHolder(ItemViewHolder<Cat> vh, @NonNull Cat cat, @NonNull List<Object> payloads) {
      ...
      addDelegate(createDelegateBuilder(Dog.class)
          ...
          .binder(new ViewBinderWithoutPayloads<Dog>() {
            @Override
            public void onBindViewHolder(ItemViewHolder<Dog> vh, @NonNull Dog dog) {
      ...
      addDelegate(createDelegateBuilder(Gecko.class)
          ...
          .binder(new ViewBinder<Gecko>() {
            @Override
            public void onBindViewHolder(ItemViewHolder<Gecko> vh, @NonNull Gecko gecko, @NonNull List<Object> payloads) {
      ...
      addDelegate(createDelegateBuilder(Snake.class)
          ...
          .binder(new ViewBinder<Snake>() {
            @Override
            public void onBindViewHolder(ItemViewHolder<Snake> vh, @NonNull Snake snake, @NonNull List<Object> payloads) {
      ...
      setFallbackDelegate(createDelegateBuilder(DisplayableItem.class)
          ...
          .binder(new ViewBinder<DisplayableItem>() {
            @Override
            public void onBindViewHolder(ItemViewHolder<DisplayableItem> vh, @NonNull DisplayableItem item, @NonNull List<Object> payloads) {
